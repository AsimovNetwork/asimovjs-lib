...
export class Signature {
  ...
  static fromCompact(buf) {
    ...
    sig.i = i;
    sig.r = BN.Bn.fromBuffer(b2);
    sig.s = BN.Bn.fromBuffer(b3);

    return sig;
  };

  static fromDER(buf, strict?: any) {
  ...
  static fromBuffer = Signature.fromDER
   ...
   */
  public hasLowS() {
    if (this.s.lt(new BN.Bn(1)) ||
      this.s.gt(new BN.Bn('7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF5D576E7357A4501DDFE92F46681B20A0', 'hex'))) {
      return false;
    }
    return true;
  };
