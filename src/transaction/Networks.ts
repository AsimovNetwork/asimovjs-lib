 ...
 * @return Network
 */
export let addNetwork = function(data) {
 ...
 */
export let removeNetwork = function(network) {
...
export let defaultNetwork = testnet;
 ...
 * @return Network
 */
export let get = function(arg, keys ? : any) {
