...
var Base58Check = require('../../lib/index').Base58Check;
...
describe('PrivateKey', function() {
  ...
  var wifTestnet = '2U5vqr6bGyMwrjKbb7SVfsbV1zkP9v2hNhRgkQRnrirCD4UrCc';
  var wifTestnetUncompressed = '29PptoFvnndn8ELxsC9gYtqf2cewaUwTg2S41W8gQ9KatR4DJi';
  var wifLivenet = '643kPdAtR6RLAuu7aYDKZmokr8NTtnKNjFKaHDatu9j2DVLNB77';
  var wifLivenetUncompressed = '29PptoFvnndn8ELxsC9gYtqf2cewaUwTg2S41W8gQ9KatR4DJi';
  ...
  describe('instantiation', function() {
    ...
    it('should not be able to instantiate with unknown network', function() {
      // expect(function() {
      //   return new PrivateKey(new BN.Bn(2), 'unknown');
    ...
    it('should create a livenet private key', function() {
      var privkey = new PrivateKey(BN.Bn.fromBuffer(buf), 'livenet');
    ...
    it('should create a default network private key', function() {
      ...
      // var a = new PrivateKey(BN.Bn.fromBuffer(buf));
      // a.network.should.equal(Networks.livenet);
      // // change the default
      // Networks.defaultNetwork = Networks.testnet;
      // var b = new PrivateKey(BN.Bn.fromBuffer(buf));
  ...
  describe('#toAddress', function() {
    it('should output this known livenet address correctly', function() {
      ...
      address.toString().should.equal('0x6663d75a7f8b447c8b911efa14a621bcc422d2dd9c');
    });

    it('should output this known testnet address correctly', function() {
      var privkey = PrivateKey.fromWIF('cR4qogdN9UxLZJXCNFNwDRRZNeLRWuds9TTSuLNweFVjiaE4gPaq');
      var address = privkey.toAddress();
      address.toString().should.equal('0x668ea263fd94aa5b0238982d4b5e05ba806a34691f');
    });
  ...
  describe('#inspect', function() {
    it('should output known livenet address for console', function() {
      ...
      privkey.inspect().should.equal(
        '<PrivateKey: b9de6e778fe92aa7edb69395556f843f1dce0448350112e14906efc2a80fa61a, network: testnet>'
      );
    });
    ...
    it('outputs "uncompressed" for uncompressed imported WIFs', function() {
      var privkey = PrivateKey.fromWIF(wifLivenetUncompressed);
      privkey.inspect().should.equal('<PrivateKey: 96c132224121b509b7d0a16245e957d9192609c5637c6228311287b1be21627a, network: testnet, uncompressed>');
    });
  });
  ...
  describe('buffer serialization', function() {
    ...
    it('roundtrips correctly when using toBuffer/fromBuffer', function() {
      var privkey = new PrivateKey(BN.Bn.fromBuffer(buf));
    ...
    it('will output a 31 byte buffer', function() {
      var bn = BN.Bn.fromBuffer(new Buffer('9b5a0e8fee1835e21170ce1431f9b6f19b487e67748ed70d8a4462bc031915', 'hex'));
    ...
    //   var bn = BN.Bn.fromBuffer(buf.slice(0, 31));
  ...
  describe('#fromRandom', function() {
    ...
    it('should set bn gt 0 and lt n, and should be compressed', function() {
      ...
      privkey.bn.gt(new BN.Bn(0)).should.equal(true);
  ...
  describe('#toPublicKey', function() {
    ...
    it('should convert this known PrivateKey to known PublicKey', function() {
      var privhex = '906977a061af29276e40bf377042ffbde414e496ae2260bbf1fa9d085637bfff';
      var pubhex = '02a1633cafcc01ebfb6d78e39f687a1f0995c62fc95f51ead10a02ee0be551b5dc';
      var privkey = new PrivateKey(new BN.Bn(new Buffer(privhex, 'hex')));
  ...
  it('creates an address as expected from WIF, livenet', function() {
    ...
    privkey.publicKey.toAddress().toString().should.equal('0x66fae5eed3fd00bfe34fcb167bad3df75a880ae038');
  });
  ...
  it('creates an address as expected from WIF, testnet', function() {
    ...
    privkey.publicKey.toAddress().toString().should.equal('0x662f225ac91e3a6d9fe1b00729a08dfa451d141297');
  });
