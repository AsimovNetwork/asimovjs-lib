...
// var bitcore = require('../..');
// var Random = bitcore.utils.Random;
var Random = require('../../lib/index').Random
...
describe('Random', function() {
  ...
  describe('@getRandomBuffer', function() {
    ...
    // it('getRandomBufferBrowser', function() {
    //   var bytes1 = Random.getRandomBufferBrowser(8);
    //   // bytes1.toString('hex').should.not.equal(bytes2.toString('hex'));
    //   console.log(bytes1)
    // });

    it('getPseudoRandomBuffer', function() {
