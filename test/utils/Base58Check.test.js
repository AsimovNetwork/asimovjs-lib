...
// var bitcore = require('../..');
// var Base58Check = bitcore.utils.encoding.Base58Check;
// var Base58 = bitcore.utils.encoding.Base58;
var Base58Check = require('../../lib/index').Base58Check
var Base58 = require('../../lib/index').Base58
...
describe('Base58Check', function() {
  ...
  it('should allow this handy syntax', function() {
    ...
    new Base58Check(enc).toBuffer().toString('hex').should.equal(buf.toString('hex'));
  });

  describe('#set', function() {

    it('should set a buf', function() {
      should.exist(new Base58Check().set({buf: buf}).buf);
    });
  ...
  describe('#fromBuffer', function() {
    ...
    it('should set buffer', function() {
      var b58 = new Base58Check().fromBuffer(buf);
  ...
  describe('#toBuffer', function() {
    ...
    it('should return the buffer', function() {
      var b58 = new Base58Check({buf: buf});
      b58.buf.toString('hex').should.equal(buf.toString('hex'));
    });
